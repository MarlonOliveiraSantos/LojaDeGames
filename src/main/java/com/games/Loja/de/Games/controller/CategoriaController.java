...
public class CategoriaController {
    ...
    public ResponseEntity<List<Categoria>> getByDescription(@PathVariable String description){
        return ResponseEntity.ok(categoriaRepository.findAllByDescriptionContainingIgnoreCase(description));
    }
